...
var GetSeason = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var seasons, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, anime_episode_1.getBySeason)({ season: req.params.season, owner: req.params.owner })];
            case 1:
                seasons = _a.sent();
                return [2 /*return*/, res.status(200).json(seasons).end()];
            case 2:
                error_2 = _a.sent();
                console.log(error_2);
                return [2 /*return*/, res.sendStatus(400)];
