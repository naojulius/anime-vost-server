...
var isAuthenticated = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var sessionToken, existingUser, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                sessionToken = req.cookies['auth'];
                if (!sessionToken) {
                    return [2 /*return*/, res.sendStatus(403)];
                }
                return [4 /*yield*/, (0, user_1.getUSerBySessionToken)(sessionToken)];
            case 1:
...
var isOwner = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        try {
            id = req.params.id;
            currentUserId = (0, lodash_1.get)(req, 'identity._id');
            if (!currentUserId) {
                return [2 /*return*/, res.sendStatus(403)];
            }
